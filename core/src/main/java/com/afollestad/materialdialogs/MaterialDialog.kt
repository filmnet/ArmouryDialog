...
import com.afollestad.materialdialogs.utils.maybeSetManualTextColor
...
class MaterialDialog(
  ...
  fun positiveButton(
    ...
    maybeSetManualTextColor(
        btn,
        attrRes = R.attr.md_color_positive,
    ...
    populateText(
        ...
        textColor = R.attr.md_color_positive,
        textColorRes = textColorRes,
        textSize = R.attr.md_size_positive,
        textSizeRes = textSizeRes
    )
  }
  ...
  fun negativeButton(
    ...
    maybeSetManualTextColor(
        btn,
        attrRes = R.attr.md_color_negative,
        colorRes = textColorRes)
    ...
    populateText(
        ...
        typeface = this.buttonFont,
        textColor = R.attr.md_color_negative,
        textColorRes = textColorRes,
        textSize = R.attr.md_size_negative,
        textSizeRes = textSizeRes
    )
  }
  ...
  fun neutralButton(
    ...
    maybeSetManualTextColor(
        btn,
        attrRes = R.attr.md_color_neutral,
        colorRes = textColorRes)
    ...
    populateText(
        ...
        text = text,
        typeface = this.buttonFont,
        textColor = R.attr.md_color_neutral,
        textColorRes = textColorRes,
        textSize = R.attr.md_size_neutral,
        textSizeRes = textSizeRes
    )
  }
