...
class DialogActionButton(
  ...
  private var isManualColor: Boolean = false
  ...
  internal fun update(
    ...
    if(!isManualColor) setTextColor(enabledColorOverride ?: enabledColor)
  ...
  fun setManualColor(isManual: Boolean) {
    this.isManualColor = isManual
  }
}
