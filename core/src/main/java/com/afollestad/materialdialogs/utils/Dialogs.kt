...
internal fun MaterialDialog.maybeSetManualTextColor(
    btn: DialogActionButton,
    attrRes : Int? = null,
    @ColorRes colorRes: Int? = null
) {
  val intColorRes = MDUtil.resolveColor(btn.context, res = colorRes)
  val intColorAttr = MDUtil.resolveColor(btn.context, attr = attrRes)
  btn.setManualColor(intColorRes != 0 || intColorAttr != 0)
}
